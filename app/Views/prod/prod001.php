    ...
    <div class="row">
        <div class="col-6 col-sm-2">
            ...
            <input type="month" class="form-control form-control-sm" value="<?php echo date('Y-m'); ?>"
                name="COMPETENCIA" id='COMPETENCIA' required pattern="[0-9]{4}-[0-9]{2}">
        </div>  
        <div class="col-md-1">
            <label>Meta</label>
...
<div class="row">
    <div class="col-12">
        <div style="max-height: 600px;" class="table-responsive">
            <table class="table table-striped table-sm table-bordered table-head-fixed" id="table_producao" style="font-size: 0.8em;">
                <thead>
                    <tr></tr>
                </thead>
                <tbody>
