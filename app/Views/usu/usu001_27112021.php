<form id="form_usuarios" autocomplete="off" enctype="multipart/form-data">
	<div class="form_crud_modal">
		...
		<div class="row">
			<div class="col-xs-12 col-md-6" style="color:red">
				<label for="">&nbsp;</label>
				<div><small>Ao cadastrar no usuario ou resetar senha, sera gerada automatica: usuario@1234      |       Ex.: joao@1234</small></div>
			</div>
		</div>
