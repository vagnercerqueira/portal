    ...
    <div class="col-12 col-sm-12">
        ...
        <form method="post" id="form_busca">
            <div class="row">
                ...
                <!--  <div class="col-1 col_bt_exclui" style="display: none;">
                    <label>&nbsp;</label>
                    <div><a href='javascript:;' type="button" data-toggle="modal" data-target="#modal-deleta_mailing" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>&nbsp;mailings</a></div>
                </div> -->
            </div>
            <br>
            <div class="row">
