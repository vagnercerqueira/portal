                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file"
                                                                class="custom-file-input form-control-sm desativado"
                                                                id="AUDIO_AUDIT_QUALITY_1" name="AUDIO_AUDIT_QUALITY_1"
                                                                accept="audio/*">
                                                            <label class="custom-file-label form-control-sm desativado"
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file"
                                                                ...
                                                                accept="audio/*">
                                                            <label class="custom-file-label desativado"
