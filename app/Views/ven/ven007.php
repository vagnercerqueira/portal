        ...
        <div class="card card-primary card-tabs">
            ...
            <div class="card-header p-0 pt-1">
                ...
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link links_uploads" id="custom-tabs-venda_lote-home-tab" data-toggle="pill"

                            href="#custom-tabs-venda_lote-home" role="tab" aria-controls="custom-tabs-venda_lote-home"

                            aria-selected="false">Venda lote</a>

                    </li>

                   <li class="nav-item">
                        <a class="nav-link links_uploads" id="custom-tabs-brpronto-messages-tab" data-toggle="pill"
                            href="#custom-tabs-brpronto-messages" role="tab" aria-controls="custom-tabs-brpronto-messages"
                            aria-selected="false">BRPRONTO</a>
                    </li>

                    <li class="nav-item">

                        <a class="nav-link links_uploads" id="custom-tabs-bov-messages-tab" data-toggle="pill"

                            href="#custom-tabs-bov-messages" role="tab" aria-controls="custom-tabs-bov-messages"

                            aria-selected="false">BOV</a>
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link links_uploads" id="custom-tabs-dfv-settings-tab" data-toggle="pill"

                            href="#custom-tabs-dfv-settings" role="tab" aria-controls="custom-tabs-dfv-settings"

                            aria-selected="false">DFV</a>
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="custom-tabs-one-tabContent">
                                            ...
                                            <div class="tab-pane panel-primary fade show active"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-3">
                                                        ...
                                                        <label for="PDF_AUDIT">Auditoria 3 (PDF)</label>

                                                        <div class="custom-file">

                                                            <input type="file" class="custom-file-input form-control-sm"

                                                                id="PDF_AUDIT" name="PDF_AUDIT"

                                                                accept=".pdf">

                                                            <label class="custom-file-label"

                                                                for="PDF_AUDIT">Selecionar</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <textarea class="form-control form-control-sm" rows="3"
                                                            ...
                                                            name="OBS_TRATAMENTO_BKO" id='OBS_TRATAMENTO_BKO'
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <textarea class="form-control form-control-sm" rows="3"
                                                            ...
                                                            name="OBS_TRATAMENTO_SUPERVISOR"
                                ...
                                <div class="col-2">
                                    ...
                                    <span class="float-right">
                                        ...
                                        <button type="button" data-toggle="modal" data-target="#modal-exportar_ven"
                                            ...
                                            class="btn btn-success btn-sm btn_download"><i
                   ...
                   <div class="tab-pane fade" id="custom-tabs-brpronto-messages" role="tabpanel"
                        aria-labelledby="custom-tabs-brpronto-messages-tab">
                        <form method="post" id="form_upload_brpronto">
                            <div class="row">
                                <div class="col-10">
                                    <label class='text-danger'>Arquivos aceitos: .csv</label>
                                    <span class='float-right timer_upload_brpronto'>
                                        <span class="timer_upload_ini_brpronto"></span>
                                        <span class="timer_upload_fim_brpronto"></span>
                                    </span>
                                    <input type="file" accept=".csv" required id="files_brpronto" style="visibility: hidden"
                                        multiple name="files_brpronto[]" />
                                </div>
                                <!--<div class="col-md-2">
                                    <label>&nbsp;</label>
                                    <a class="btn btn-success btn-sm btn_download_brpronto float-right"
                                        data-colscsv="<?php echo implode(";",$option_cols_dfv); ?>"><i
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="btn-group w-100">
                                        <span class="btn btn-success col fileinput-button dz-clickable"
                                            onclick="openDialogbrpronto()">
                                            <i class="fas fa-plus"></i>
                                            <span>Add arquivos brpronto</span>
                                        </span>
                                        <button type="submit" class="btn btn-primary col start">
                                            <i class="fas fa-upload"></i>
                                            <span>Iniciar upload</span>
                                        </button>
                                        <button type="reset" class="btn btn-warning col cancel_brpronto">
                                            <i class="fas fa-times-circle"></i>
                                            <span>Cancelar upload</span>
                                        </button>
                                    </div>
                            ...
                            <div class="card card-default">
                                <div class="card-body">
                                    <div class="row row_msg_upload_brpronto"></div>
                                    <div class="row">
                                        <div class="col-12">
                                            <table class="table table-striped table_files_brpronto table-sm table-bordered">
                                                <tbody></tbody>
                                            </table>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-bov-messages" role="tabpanel"

                        aria-labelledby="custom-tabs-bov-messages-tab">
                        ...
                        <form method="post" id="form_upload_bov">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <input type="file" accept=".csv" required id="files_bov" style="visibility: hidden"

                                        multiple name="files_bov[]" />
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm btn_download_bov float-right"

                                        data-colscsv="<?php echo implode(";",$option_cols_bov); ?>"><i
                    ...
                    <div class="tab-pane fade" id="custom-tabs-blindagem-settings" role="tabpanel"

                        aria-labelledby="custom-tabs-blindagem-settings-tab">
                        ...
                        <form method="post" id="form_upload_blindagem">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <input type="file" accept=".csv" required id="files_blindagem"

                                        style="visibility: hidden" multiple name="files_blindagem[]" />
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm btn_download_blindagem float-right"

                                        data-colscsv="<?php echo implode(";", $option_cols_blindagem); ?>"><i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <table
                                                ...
                                                class="table table-striped table_files_blindagem table-sm table-bordered">
                    ...
                    <div class="tab-pane fade" id="custom-tabs-dfv-settings" role="tabpanel"

                        aria-labelledby="custom-tabs-dfv-settings-tab">
                        ...
                        <form method="post" id="form_upload_dfv">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <input type="file" accept=".zip" required id="files_dfv" style="visibility: hidden"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" autocomplete="off" title="minimo de 8 caracteres"

                                            class="form-control text-center" required minlength="8"

                                            placeholder="Buscar por CEP OU CDO" name='cep_or_cdo'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            ...
                            <input type="date" class="form-control form-control-sm text-center" name="expo_per_fim"
                                ...
                                id="expo_per_fim" value="<?php echo date("Y-m-d"); ?>" required />
