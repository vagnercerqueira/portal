    ...
    <div class="container-fluid">
        <div class="row">
            <div class="alert alert-warning" role="alert">
                ...
                | GROSS: <a data-toggle="modal" href="#" class="small-box-footer" data-target="#modal-exportar_ven"
                    data-titulo="Instaladas BOV" style="color:black; text-decoration: underline;"><span
                        id="total_instalada">0</span></a>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3>
                            <span id="venda_emtratamento">0</span>
                            <span>&nbsp;-&nbsp;</span>
                            <span id="vendas_emtratamento_atrasado" data-toggle="tooltip" data-placement="top"
                                title="Tratamentos atrasados">0</span>
                        </h3>
