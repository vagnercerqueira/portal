...

{
    ...
    public function index()
    {
        ...
        if ($metodo !== "post") {
            ...
            if (!$this->validate($rules)) {
                ...
                $banco = $this->clientes_permitidos($dPost['cliente_db']);
    ...
    {        
        ...
        if($cli_required){
            $sql = "SELECT nome, status, logo, codigo_db FROM clientes WHERE codigo_db=? AND status=?";
            $clis = $db_cpanel->query($sql, [$cliente, 'A'])->getResultArray();
        }else{
