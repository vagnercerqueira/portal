...
class Ven007 extends BaseController
{
...

    {
        ...
        #e não houve ajuste anteriormente pelo BKO, o sistema já coloca automaticamente em tratamento, com retorno para o dia seguinte.
    ...
    public function sqlExportarvendas($data_inicial, $data_final)
    {
        ...
        if ($cod_interno == 9999 || $cod_interno == 1000) {
            ...
            $cabecalho = [
                ...
                "Velocidade", "TV", "Status BOV", "Status Tratamento", "Responsavel", "Retorno", "Situacao Ativacao", "MIG FIB", "MIG VOIP",
